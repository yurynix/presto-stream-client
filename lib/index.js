...
console.log(`sslOptions: ${sslOptions ? 'yes' : 'no'} ${JSON.stringify(opts)}`)
        ...
        req.on('response',(res)=>{
            ...
            console.log(`${opts.host}:${opts.port}${opts.path} -> ${res.statusCode}`);
            const response_data = [];
            res.on('data', (chunk)=>{
                console.log(`${opts.path}`, chunk.toString());
