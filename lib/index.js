...
class Client {
    ...
    constructor(args = {}){
        ...
        this[s_request] = (opts)=>{
            ...
            return makeRequest(requestOpts,contentBody,this[s_ssl],this.jsonParser);
        };
        ...
        try {
            ...
            */
            if(data.error) {
                ...
                return await this.cancel(); //end run if error, and attempt to cancel on Presto as well
            }
